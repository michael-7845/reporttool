...
class ListComparatorByWeight implements Comparator<Map<String, String>> {  
    @Override  
    public int compare(Map<String, String> me1, Map<String, String> me2) {  
    	double d1 = Double.valueOf(me1.get("weight"));
    	double d2 = Double.valueOf(me2.get("weight"));
        if (d1 > d2) {
        	return -1;
        }	
        else if (d1 < d2) {
